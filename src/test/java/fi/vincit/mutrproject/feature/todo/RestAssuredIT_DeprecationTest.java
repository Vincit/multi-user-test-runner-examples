...
import fi.vincit.mutrproject.testconfig.AbstractConfiguredRestAssuredIT;
...
@RunWithUsers(
        ...
        consumers = {"role:ROLE_ADMIN", "role:ROLE_USER", "user:user1", RunWithUsers.PRODUCER, RunWithUsers.ANONYMOUS}
)
